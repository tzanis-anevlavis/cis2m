...
elseif (size(G,1)~=size(F,1))
    error('Dimensions of G and F do not much.')
elseif (size(Gu,1)~=size(Fu,1))
    error('Dimensions of Gu and Fu do not much.')
elseif (size(G,2)~=size(A,2))
    error('Dimensions of B and Gu do not much.')
elseif (size(B,2)~=size(Gu,2))
    error('Dimensions of G and F do not much.')
elseif (size(A,1)~=size(B,1))
    error('Dimensions of A and B do not much.')
end
if (nargin<4)
