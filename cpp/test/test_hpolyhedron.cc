...
int main() {
  ...
  std::cout << "b: " << std::endl
            << p5.bi().transpose() << std::endl
            << std::endl;
  std::cout << "Ae: " << std::endl << p5.Ae() << std::endl;
  std::cout << "be: " << std::endl
            << p5.be().transpose() << std::endl
            << std::endl;
